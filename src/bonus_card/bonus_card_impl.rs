...
impl BonusCard {
  ...
  pub fn scoring_rule(&self) -> ScoringRule {
    match self {
      ...
      Self::ForestPopulationMonitor => ScoringRule::Ladder(Box::new([(2, 3), (4, 5), (5, 8)])),
      Self::ForestRanger => ScoringRule::Ladder(Box::new([(3, 3), (4, 5), (5, 8)])),
      Self::GrasslandPopulationMonitor => ScoringRule::Ladder(Box::new([(2, 3), (4, 5), (5, 8)])),
      ...
      Self::WetlandPopulationMonitor => ScoringRule::Ladder(Box::new([(2, 3), (4, 5), (5, 8)])),
